...
${form.message}`;
  ...
  return (
    ...
    <section className="min-h-screen w-full bg-[#F9F7F2] px-5 md:px-12 py-24 font-Cinzel overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <h1 className="text-4xl md:text-6xl font-Cinzel font-bold text-[#1B1B1B] mt-4 leading-tight">
            Plan Your Special Day At Tyagi Farms
          </h1>

          <p className="text-gray-600 mt-5 leading-relaxed">
            Book weddings, birthdays, private parties, family gatherings and
            farmhouse events with a premium experience.
          </p>

          <div className="mt-8 space-y-3 text-gray-700">
            <p>📍 Herbertpur, Dehradun</p>
            <p>📞 Contact directly on WhatsApp</p>
            <p>✨ Wedding | Party | Celebration | Farmhouse Stay</p>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <option value="Wedding Booking">Wedding Booking</option>
            <option value="Birthday Party">Birthday Party</option>
            <option value="Private Party">Private Party</option>
            <option value="Family Gathering">Family Gathering</option>
            <option value="Farmhouse Stay">Farmhouse Stay</option>
          </select>
